...
* tone (T key, then 0-5 keys): select synth tone - 'spring', 'organ' and 'wind' tones are from [soundtoy] [soundtoy] (Note: the dropdown remains open until you click 'tone' or press 'T' by design)
